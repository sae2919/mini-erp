...
<div class="py-4 space-y-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="bg-blue-50 border border-blue-100 rounded-xl p-6 text-center flex flex-col justify-center">
            ...
            <p class="text-4xl font-bold text-blue-800 mt-2">₹{{ number_format($purchase->total_amount, 2) }}</p>
        </div>
    </div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr>
                    ...
                    <td class="px-4 py-3 text-gray-600">₹{{ number_format($item->cost_price, 2) }}</td>
            ...
            <tfoot class="border-t-2 border-gray-200">
                <tr>
                    ...
                    <td class="px-4 py-3 font-bold text-blue-800 text-base">₹{{ number_format($purchase->total_amount, 2) }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
    ...
    <div class="flex justify-end">
        <form method="POST" action="{{ route('purchases.destroy', $purchase) }}"
              onsubmit="return confirm('Reverse this purchase? Stock will be decremented back.')">
            @csrf @method('DELETE')
